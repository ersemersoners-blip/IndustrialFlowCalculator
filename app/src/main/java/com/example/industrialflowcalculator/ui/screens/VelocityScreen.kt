...
import com.example.industrialflowcalculator.viewmodel.VelocityViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun VelocityScreen(navController: NavController, vm: VelocityViewModel = viewModel()) {
    val state by vm.state.collectAsState()

    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Velocidade do Fluido") },
                navigationIcon = {
        ...
        Column(
            ...
            Text("Fórmula: v = Q / A", fontWeight = FontWeight.Bold)
